...
export function FilterChip({ label, active, onClick, icon, className = '' }: FilterChipProps) {
  return (
    <button
      ...
      onClick={onClick}
      aria-pressed={active}
      className={`inline-flex items-center gap-1.5 rounded-full text-sm px-3.5 py-1.5 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-text min-h-[36px] ${
        active
