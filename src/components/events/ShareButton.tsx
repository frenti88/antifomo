  ...
  const handleShare = async () => {
    ...
    if (navigator.share && navigator.canShare && navigator.canShare(shareData)) {
      ...
      try {
        ...
        setToastMessage('¡Enlace copiado para rotarlo!');
  ...
  return (
    <div className={`relative inline-block ${className}`}>
      <button
        ...
        className="w-11 h-11 flex items-center justify-center rounded-full hover:bg-surface active:scale-90 transition-all duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-text text-secondary hover:text-text"
      >
